...
const List<LibraryBook> libraryBookCatalog = [
  ...
  LibraryBook(
    ...
    authorDeathAr: 'من علماء القرن الثامن الهجري',
    descriptionAr:
