...
اقرأ `CLAUDE.md` الأول (المنهج الملزم)، وبعده **`WORK_QUEUE.md`** (أول تلات أقسام:
السابعة F1–F4، السادسة E1–E8، الخامسة D1–D6)، وبعدها `HANDOVER.md`.
...
- المُصدَر: **v3.17.2** على `master`. أول حاجة:
  `gh release view v3.17.2 --json tagName,targetCommitish,assets` وتأكد إن SHA
...
4. **الضغطة على المصحف المصوّر وهو ملء الشاشة بتظهر الخيارات بدل ما تفتح
   الآية** — ده مقصود (طلبه). الآية تتفتح لما الخيارات ظاهرة.
