...
BOOKS = {
    ...
    "maqasid_al_riayah": {
        "shamela_id": 6875,
        "source_label": "المكتبة الشاملة — مقاصد الرعاية لحقوق الله عز وجل، للعز بن عبد السلام (ت ٦٦٠ هـ)، وهو اختصاره لكتاب «الرعاية» للحارث المحاسبي، تحقيق إياد خالد الطباع",
    },
    ...
    "hjh_alnby": {
        "shamela_id": 399,
        "source_label": "المكتبة الشاملة — حجة النبي، لـالإمام البخاري — بأحكام الألباني، المكتب الإسلامي - بيروت، الخامسة - ١٣٩٩",
    },
    "altwsl_anwaah_wahkamh": {
        "shamela_id": 7592,
        "source_label": "المكتبة الشاملة — التوسل أنواعه وأحكامه، لـالإمام البخاري — بأحكام الألباني، محمد عيد العباسي، مكتبة المعارف للنشر والتوزيع - الرياض، الطبعة الأولى ١٤٢١ هـ - ٢٠٠١ م",
    },
    "shyh_alsyrh_alnbwyh_alalbany": {
        "shamela_id": 592,
        "source_label": "المكتبة الشاملة — صحيح السيرة النبوية - الألباني، لـالإمام البخاري — بأحكام الألباني، المكتبة الإسلامية، عمان - الأردن، الأولى، ١٤٢١ هـ",
    },
    "jlbab_almrah_almslmh_fy_alktab_walsnh": {
        "shamela_id": 9994,
        "source_label": "المكتبة الشاملة — جلباب المرأة المسلمة في الكتاب والسنة، لـالإمام البخاري — بأحكام الألباني، دار السلام للنشر والتوزيع، الثالثة، ١٤٢٣هـ -٢٠٠٢ م",
    },
    "ahkam_aljnayz": {
        "shamela_id": 854,
        "source_label": "المكتبة الشاملة — أحكام الجنائز، لـالإمام البخاري — بأحكام الألباني، المكتب الإسلامي، الرابعة، ١٤٠٦ هـ - ١٩٨٦ م",
    },
    "adab_alzfaf_fy_alsnh_almthrh": {
        "shamela_id": 7494,
        "source_label": "المكتبة الشاملة — آداب الزفاف في السنة المطهرة، لـالإمام البخاري — بأحكام الألباني، دار السلام، الطبعة الشرعية الوحيدة ١٤٢٣هـ/٢٠٠٢مـ",
    },
