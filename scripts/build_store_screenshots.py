...
SHOTS = [
    ...
    # 2026-09-22: the memorization section takes this slot. Play allows
    # eight, azkar is in every app of this kind, and «التحفيظ والتسميع» is
    # what is new here.
    ('04_hifz', '13_hifz', 'احفظ آية آية، وسمّع لنفسك',
     'كرّر الآية بصوت القارئ، وأخفِ كلماتها كلمة كلمة، وراجعها في موعدها'),
