...
<!-- WIP:START -->
**2026-09-17 18:31 — IN PROGRESS — resume here**

checkpoint(wip): 23 books hosted, 209 in the catalogue, four still building. Two sourceLabels were corrected after reading the built files' own edition cards rather than trusting what I had written from the Shamela title: مدارج السالكين is تحقيق محمد المعتصم بالله البغدادي and قوت القلوب is تحقيق د. عاصم إبراهيم الكيالي, and neither label named its muhaqqiq. Naming the printing is what 1.2 requires, and a label that stops at the publisher reads as though the text came from an unedited printing. That is the third time today the edition card contradicted the title I searched by - the first was maqasid_al_riayah being العز بن عبد السلام and not المحاسبي, the second was jami_al_ulum_wal_hikam crediting a living editor under a label the audit did not know. The rule that keeps working: read the card the builder prints, never the title you searched for. The shelf test is still red on one assertion and for the right reason - al_muwafaqat is not in the catalogue yet so firstWhere throws. It goes green when the last four land: al_burhan, al_itqan, al_muwafaqat, al_risalah_al_qushayriyyah
