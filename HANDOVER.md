...
| | |
|---|---|
| **Last updated** | 2026-09-23 (night, v3.58.0 released) |
...
<!-- WIP:START -->
**2026-09-23 21:30 — COMPLETE**

COMPLETE — v3.58.0 published and verified (see the RELEASED row at the top). R2 recitation mirror complete: 18,936 objects counted by prefix, ends range-checked 206; Class A for the period closed at 961,960 / 1,000,000 (period resets 2026-09-24T00:00Z = 04:00 Dubai). Next: the owner confirms recitation on HIS phone with 3.58.0. Tajweed model PARKED by the owner. `py -3 scripts/r2_usage.py` reads storage/Class A/B/billing period live.
