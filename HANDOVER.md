...
<!-- WIP:START -->
**2026-09-13 01:15 — IN PROGRESS — resume here**

«في مثل هذا اليوم» is wired in and VERIFIED on emulator-5554, and the four empty days were throttling, not gaps. Tapping either date in the Home header - Hijri or Gregorian, both open the same sheet - brings up the ornamented card with ٢ ربيع الآخر ١٤٤٨ هـ over الأحد ١٣ سبتمبر ٢٠٢٦ and twelve events under في مثل هذا اليوم, Islamic ones ordered first exactly as intended (القدس ١٩٣٦, توسعة المسجد الحرام ١٩٨٨, التل الكبير ١٨٨٢), with the CC BY-SA credit line at the foot of the sheet. The assets are now in pubspec (they were built but never bundled, so the card would have said «لا توجد أحداث» however good the data was - trap 27's shape again). MEASURED after the fix: ar 366 days, 0 empty, min 9 events, 4388 total; en 366 days, 0 empty, min 12, 4392 total. The four days that came back empty (ar 12-22, en 01-22 10-09 10-14) were refetched one at a time and every one returned a full twelve from the same events endpoint - Wikimedia had simply throttled the burst, which is trap 38 again and is why a helper that swallows the failure turns «you are rate-limited» into «there is nothing there». Also hardened the loader: gzip.decode was being assigned through s dynamic into a Uint8List, which compiles and can throw at runtime; it is Uint8List.fromList now.
