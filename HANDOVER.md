...
<!-- WIP:START -->
**2026-09-17 17:25 — IN PROGRESS — resume here**

checkpoint(wip): islamqa and dorar out, three verified institutions in, and a new طالب العلم shelf with 28 books being built. He had not named islamqa or dorar, but his rule was أي حاجة ابن باز داخل فيها شيلها and those two ARE the two largest online archives of exactly those fatwas, so I put that in front of him rather than deciding it quietly - he said remove them and find replacements. All three replacements were fetched before being written down: dar-alifta.org answered 200 with 179961 bytes and its own title فتاوي دار الإفتاء المصرية, azhar.eg 200 with بوابة الأزهر الإلكترونية, nabulsi.com 200 with موسوعة النابلسي للعلوم الإسلامية, and each landing page was searched for the three removed names and returned ZERO. النابلسي is not a coincidence - his channel is one of the nine kept. Then the real finding: the library holds 99 tazkiyah books and NOT ONE by الغزالي or ابن رجب or الشاطبي or الماوردي or ابن حزم or المحاسبي or الخطيب البغدادي or ابن عبد البر - measured by grepping each name over the whole catalogue and getting zero. It is almost entirely ابن أبي الدنيا and ابن الجوزي. So 28 books go in: 13 on the self-development and adab shelves (إحياء علوم الدين، مدارج السالكين، جامع العلوم والحكم، أدب الدنيا والدين، الأخلاق والسير) and 15 on the new talibIlm one, graduated - آداب الطلب first, then مصطلح الحديث and أصول الفقه and علوم القرآن and النحو. Every id came from the local Shamela TITLE index, never from Shamela's own search which returns a commentary above the book it comments on. الاعتصام للشاطبي is deliberately absent while الموافقات is in: he asked to stay far from تشدد and الموافقات is the مقاصد book while الاعتصام is the polemic. analyze clean, 319 tests
