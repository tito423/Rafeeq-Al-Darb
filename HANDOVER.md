...
<!-- WIP:START -->
**2026-09-17 16:02 — IN PROGRESS — resume here**

morning and evening are two lists now, and there is a third reminder. The split: an-Nawawi keeps them in ONE bab, «باب ما يُقال عند الصباح وعند المساء», so each curated entry says WHEN it is said and the chapter splits at build time - morning opens on «أَصْبَحْنَا وأصْبَحَ المُلْكُ لِلَّهِ رَبّ العَالَمِينَ» and evening on «أمْسَيْنا وأمْسَى المُلْكُ لِلَّهِ». A dua tagged «both» stands in both lists, because the narration itself says «حين يصبح وحين يمسي» - that is the book instructing, not a duplication invented here. The half-titles are his own words cut at his own «و». And hadith ٢٠٨ carries BOTH wordings in one narration; only the morning half had been curated, so «اللَّهُمَّ بِكَ أمْسَيْنا، وَبِكَ نَحْيا، وَبِكَ نَمُوتُ وَإِلَيْكَ النُّشُورُ» is its own entry now. 20 chapters, 60 supplications, morning 11 and evening 10. The sleep reminder is built on the same shape as the other two - id 6003, one exact daily alarm, no default time, off until it is set - with its row in the settings sheet and three new keys in all seven locales. analyze clean, 314 tests
