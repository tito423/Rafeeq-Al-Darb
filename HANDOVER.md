...
<!-- WIP:START -->
**2026-09-17 15:17 — IN PROGRESS — resume here**

the UAE copyright law read from the owner's own PDF - a 22-page scan with zero extractable text, rendered and read page by page - and it settles three things this project had been reasoning about. Federal Decree-Law 38/2021, gazette pages 430-431. Article 3(4): a work in the public domain is excluded from protection outright, so an-Nawawi's text is free. The sentence immediately after it: «ومع ذلك تتمتع مجموعات ما ورد في البنود 2، 3، 4 بالحماية إذا تميز جمعها أو ترتيبها أو أي مجهود فيها بالابتكار» - a COLLECTION of free works IS protected when its gathering or arrangement is innovative, which is حصن المسلم exactly: the duas are prophetic and free and the selection and arrangement are al-Qahtani's. The law names the case; it was not our theory. And the definition of المصنف المشتق names الترجمات explicitly, with Article 2(12) protecting derivative works «دون الإخلال بالحماية المقررة للمصنفات التي اشتقت منها» - the Qur'an being free does not make a translation of it free, which settles the 47 translations as a matter of principle. Recorded in CONTENT-LICENSES.md with the Arabic quoted verbatim. What is still NOT answered and not guessed at: whether a muhaqqiq's apparatus over a public-domain matn is protected as a derivative work or simply as his own writing - under Article 2(1) it is his own text either way, which is the ground the filtering stands on. Also: the signed v3.32.0 release APK installed over the debug build with adb install -r and returned Success, which is the signing lineage doing its job, and it runs clean on the emulator - prayer times live for Dubai, quote of the day in English, More screen intact, and logcat shows 0 E/flutter and 0 FATAL EXCEPTION
