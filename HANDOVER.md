...
<!-- WIP:START -->
**2026-09-17 21:19 — IN PROGRESS — resume here**

v3.34.0 — version bumped in both places, release built and signed. sign_release.py printed OK: rotated, so the new key covers Android 9+ and the debug key still covers 7-8, which is what keeps this an update rather than a reinstall over hundreds of MB of downloaded content. analyze clean, 342 tests, library 213 with 213/213 sizes matching the bucket and zero editor apparatus on the widened audit
