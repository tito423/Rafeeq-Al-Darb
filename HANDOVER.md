...
<!-- WIP:START -->
**2026-09-17 15:59 — IN PROGRESS — resume here**

seen on the device at last, on the RIGHT build this time, and it found one more thing. The ruqyah screen opens and shows an-Nawawi's supplications with an-Nawawi's takhrij: «لا بأسَ طَهُورٌ إنْ شاءَ اللَّه» under «صحيح البخاري», «أسألُ اللَّهَ العَظِيمَ رَبّ العَرْشِ العَظِيمِ أنْ يَشْفِيكَ» under «قال الترمذي: حديث حسن». The explicit ids resolve to the right duas on a real screen, not only in a test. But three strings still NAMED حصن المسلم - the Adhkar hub subtitle and two lines on the ruqyah screen - telling a reader he is looking at a book the app no longer ships. Same family as «من كتاب الشيخ ابن باز», which outlived its manual by three commits. All three rewritten in all seven locales onto «الأذكار» للنووي. The Russian one nearly escaped: it had the book's name TRANSLATED, «Крепости мусульманина», so searching for the Arabic or the transliteration found nothing - it was caught by printing the three keys per locale and reading them. no_removed_book_named_test.dart now searches every locale for every spelling of a removed book, Ibn Baz included. analyze clean, 314 tests
