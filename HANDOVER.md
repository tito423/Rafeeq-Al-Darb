...
<!-- WIP:START -->
**2026-09-17 12:56 — IN PROGRESS — resume here**

the azkar extractor, built and verified against pages read by hand. an-Nawawi's al-Adhkar cut into 338 chapters and 1,392 items, 1,241 of them his numbered narrations. Four things the book taught that no amount of reasoning would have: the structure is NOT in the k field (4,414 body paragraphs, 19 heads) - every chapter opens typographically as «(باب ما يقولُ إذا استيقظَ مِن مَنامه)» in plain parentheses; 341 paragraphs are عبد القادر الأرنؤوط's footnotes carried in the ordinary body stream (trap #34), and the decisive mark is the closing «(*)», NOT the opening «(١)» - requiring both let through a footnote on page 18 that opens with «=», the same leading-equals the Musnad Ahmad crawl had to learn, and it was 750 words of the editor grading isnads; five more paragraphs have an-Nawawi's sentence and the editor's note MERGED into one, closing «(*) =», and those are dropped whole because there is no honest machine split - a few of his sentences lost beats a living editor's apparatus shipped under his name; and 763 superscript markers pointing at footnotes the reader will never see are stripped. A narration that crosses a page break is joined to itself, because emitting the tail as its own item leaves a hadith with no beginning on screen. Verified by comparing the output against pages 19-21 read by hand: the bab of waking gives exactly its seven narrations ٣٦-٤٢ with the as-Suyuti/Ibn Hajar insertion that criticises an-Nawawi gone, and entry ٤٣ reassembled across the page break. Nine leak patterns sweep the whole output at zero. NOT done yet: the DB rebuild, remapping the six ruqyah item ids, and the 338 titles in seven languages
